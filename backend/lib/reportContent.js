...
function generateTenDeitiesAnalysis(tenDeities, dm) {
  ...
  const deityMeanings = {
    'Direct Officer': 'represents authority, discipline, and structure. It governs your relationship with rules, hierarchies, and responsibility. When Direct Officer appears strongly in your chart, you have a natural respect for order and a strong sense of duty. You are likely reliable, conscientious, and respected by authority figures. The shadow side can be rigidity or excessive deference to authority. In career contexts, this deity favors management, government, law enforcement, and any role requiring clear hierarchical structure.',
    'Indirect Officer': 'represents rebellion, innovation, and challenge to authority. It fuels entrepreneurship and unconventional paths. This deity gives you the courage to question established systems and forge your own way. You are naturally skeptical of authority and prefer to test things for yourself. In career contexts, this deity favors entrepreneurship, innovation, activism, and roles where you can challenge the status quo. The shadow side can be a tendency to rebel for its own sake, or difficulty accepting guidance.',
    'Direct Wealth': 'governs stable income, material security, and traditional wealth accumulation through steady effort. This deity favors disciplined saving, consistent work, and building wealth gradually over time. Your relationship with money is likely practical and grounded. You value financial security and are willing to work steadily to achieve it. In career contexts, this deity favors banking, accounting, real estate, and any field with predictable income streams. The shadow side can be excessive focus on material security at the expense of fulfillment.',
    'Indirect Wealth': 'represents windfall opportunities, speculation, and wealth through risk-taking and unconventional means. This deity gives you an entrepreneurial instinct for spotting opportunities that others miss. You are comfortable with calculated risk and may have multiple income streams. In career contexts, this deity favors investing, sales, business development, and any field where reward is proportional to risk taken. The shadow side can be a tendency toward gambling or speculative excess.',
    'Peer': 'represents siblings, competitors, and equals. It governs your ability to collaborate and compete. When Peer is prominent, relationships with people at your same life stage are significant. You learn through comparison and competition with others. This deity favors teamwork, partnership, and collaborative ventures. The shadow side can be excessive competitiveness or difficulty standing out from the crowd.',
    'Rob Wealth': 'represents friends, social circles, and shared resources. It can indicate either generous support or resource drain. This deity governs your relationship with community and group dynamics. You are naturally oriented toward collaboration and shared endeavor. Your social network is likely a significant resource. The shadow side can be difficulty maintaining boundaries or having your resources depleted by others.',
    'Seal / Guardian': 'represents education, wisdom, mentorship, and protective energies. It governs intellectual growth and inner security. When Seal is strong, you have a natural love of learning and a deep inner life. You are protected by your knowledge and by supportive mentors. This deity favors academia, research, writing, and any field requiring deep expertise. The shadow side can be over-reliance on intellectual frameworks or resistance to practical action.',
    'Eating God': 'represents creativity, self-expression, talent, and joy. It governs your ability to generate new ideas and find satisfaction in your work. When Eating God is prominent, you are naturally creative and find joy in self-expression. You have a gift for transforming ideas into tangible results. This deity favors the arts, design, entertainment, and any field requiring creative output. The shadow side can be scattered energy or difficulty following through on ideas.',
    'Hurt Officer': 'represents artistic expression, emotional depth, rebellion through creativity, and the courage to challenge norms. This deity gives you a powerful emotional life and the ability to channel that depth into creative work. You may be drawn to art, music, or writing as vehicles for emotional truth. The shadow side can be emotional volatility or difficulty separating creative intensity from personal well-being.',
    'Servant / Output': 'mediates between self-expression and external demands, governing how you present your talents to the world. This deity represents the practical application of your gifts. You have the ability to adapt your creative output to meet the needs of your audience or market. This deity favors consulting, service professions, and any role where you apply your skills to meet others needs. The shadow side can be losing your own creative voice in service of external demands.',
  };
...
function generateDaYunAnalysis(daYun, dm) {
  ...
  const cycleGuidance = (pillar, ageRange, dmElement) => {
    const stemGuidance = {
      'Jia': 'This cycle brings Yang Wood energy — a time of pioneering, growth, and establishing new foundations. Leadership opportunities will emerge, and your capacity to inspire others is amplified. Think of this as planting season: every seed you place in the ground now will grow into a tree over the next decade. This is not a cycle for half-measures or hesitation. Your natural authority increases during this period, and people will look to you for direction. Use this influence wisely — initiate projects that align with your long-term vision. The energy of Jia is upright and principled; stay true to your values and you will build something that endures beyond this cycle.',
      'Yi': 'Yin Wood energy prevails — flexibility and adaptation will serve you better than force. This is a period for strategic alliances, creative collaborations, and patient growth. Like a climbing vine, you will find your way to the light by wrapping around obstacles rather than trying to break through them. Networking and relationship-building are particularly favored now. Your creativity flows in gentle, persistent streams rather than dramatic bursts. Pay attention to the details that others overlook — your ability to notice subtle patterns will give you a significant advantage. This is a cycle for diplomacy, art, and cultivating deep connections.',
      'Bing': 'Yang Fire radiates — visibility and recognition increase. Your social influence expands. This is a time to step into the spotlight and share your authentic self with the world. Like the sun at midday, you cannot help but be seen. Your charisma is at its peak; people are naturally drawn to your warmth and enthusiasm. This is an excellent cycle for public speaking, teaching, performing, or any activity that puts you in front of an audience. Guard against overconfidence the same fire that illuminates can also burn. Pace yourself, take time to rest between periods of intense output, and remember that even the sun sets each day.',
      'Ding': 'Yin Fire energy brings refinement and inner illumination. Your intuition sharpens. This is a period for spiritual depth, artistic expression, and cultivating meaningful relationships. Unlike the blazing sun, your light is gentle and focused, like a candle flame in the dark. This cycle favors depth over breadth, quality over quantity. Your work during this decade may not receive immediate recognition, but it will have lasting impact. Study, research, and introspection are particularly favored. Your emotional intelligence is heightened — trust your gut feelings about people and situations. This is a cycle for refinement, not expansion.',
      'Wu': 'Yang Earth brings stability and consolidation. Your foundations strengthen. This cycle favors real estate, long-term investments, and building lasting structures in your life. Think of this as the season of harvest and storage — what you have planted in previous cycles now bears fruit. Your patience and reliability are your greatest assets during this decade. People trust you because you are consistent and dependable. This is a good cycle for marriage, home-buying, and long-term commitments. However, avoid becoming too comfortable or resistant to change. The mountain stands firm, but even stone erodes over time if it never adapts.',
      'Ji': 'Yin Earth energy nourishes and sustains. This is a period of service, caregiving, and patient cultivation. Your ability to support others reaches its peak. Like rich soil, you have the power to make things grow ideas, relationships, and communities all flourish under your care. This cycle asks you to focus on the foundations: health, daily routines, and the quiet structures that support your life. You may find yourself drawn to mentorship or teaching roles. Your attention to detail and nurturing nature make you an invaluable support to those around you. Remember that even the most fertile soil needs fallow periods rest is not weakness.',
      'Geng': 'Yang Metal cuts through confusion. This is a decisive cycle for making difficult choices, cutting away what no longer serves, and pursuing justice or truth with clarity. Like a finely forged blade, your judgment is sharp and your will is strong. This is a cycle for surgery literally and metaphorically: remove what is diseased or unnecessary from your life. Your directness may intimidate others, but your clarity is a gift. Legal matters, structural changes, and major life decisions are favored now. The danger of this cycle is rigidity the sharpest blade is also the most brittle. Balance your decisiveness with compassion.',
      'Xin': 'Yin Metal refines and elevates. Your taste, discernment, and attention to detail are heightened. This period favors quality over quantity in all endeavors. Like a jeweler examining a gemstone, you can see flaws and beauty that others miss. This is a cycle for editing, polishing, and perfecting your craft. Your aesthetic sense is unusually acute — this is an excellent time for creative work that requires precision and refinement. Financially, this is a cycle for quality investments rather than speculative ventures. The challenge of Xin Metal is perfectionism: remember that a finished imperfect work is worth more than a perfect unfinished one.',
      'Ren': 'Yang Water brings depth and expansion. Your vision expands to encompass the big picture. This is a cycle for strategic thinking, philosophical exploration, and long-range planning. Like the ocean, your consciousness is vast and contains multitudes. You see connections between seemingly unrelated domains, giving you unique insights that others cannot access. This is an excellent cycle for travel, higher education, spiritual exploration, and any endeavor that expands your horizons. Big-picture thinking is favored over detailed execution. The shadow side of Ren is emotional overwhelm your depth means you feel everything intensely. Build healthy boundaries.',
      'Gui': 'Yin Water flows with adaptability. This is a cycle for navigating change with grace, building deep connections, and trusting your intuition to guide you through uncertain waters. Like rain seeping into the earth, you find your way into every crack and crevice of opportunity. This cycle rewards patience, persistence, and faith in the process. Things may not happen on your preferred timeline, but they will happen in exactly the right way. Your intuition is your most reliable guide trust the quiet voice within. This is a cycle for behind-the-scenes work, strategic waiting, and building emotional and spiritual resources for the cycles ahead.',
    };

    const guide = stemGuidance[pillar.stemEn] || 'This cycle carries a unique energetic signature that will interact with your birth chart in specific ways. Pay attention to the themes of this element in your life during this decade. The opportunities and challenges that arise will reflect the nature of this energy, and your response to them will shape the next phase of your journey.';
    const elementNote = pillar.stemElement === dmElement.replace('Yang ', '').replace('Yin ', '')
      ? ' This cycle shares the same base element as your Day Master — your natural energy is amplified, for good and for challenge. The strengths of your personality become more pronounced, but so do your blind spots. This is a time when your core nature is magnified, making it easier to achieve your goals but also easier to fall into your characteristic patterns of overcompensation. Self-awareness is especially important during this cycle.'
      : ` This cycle introduces ${pillar.stemElement} energy, which ${GENERATING_CYCLE[pillar.stemElement] === dmElement ? 'generates your Day Master, creating a supportive and nourishing current. This is a favorable cycle where the external energy feeds your inner nature, making growth feel natural and effortless. Resources and support may come from unexpected sources.' : GENERATING_CYCLE[dmElement] === pillar.stemElement ? 'is generated by your Day Master, meaning your natural energy flows outward into this cycle. You have the power to shape this period through your own efforts. Your creativity and initiative are amplified.' : 'interacts dynamically with your Day Master. This creates both opportunities and friction. The challenge is to harness the creative tension between these energies rather than being overwhelmed by it.'}.`;
...
function generateAnnualForecastContent(forecasts) {
  ...
  const annualGuidance = (f) => {
    ...
    const seasonalAdvice = f.stemElement === 'Wood' 
      ? 'opportunities for growth and new beginnings are prominent. Focus on planting seeds for the future, initiating projects, and expanding your network. This is a year to say yes to new opportunities and trust your ability to grow into them. Your natural expansion energy is supported by the cosmos — use it wisely. Pay attention to spring: the way you start this year will set the tone for the entire cycle. Small beginnings made now can grow into significant achievements by years end.'
      : f.stemElement === 'Fire'
      ? 'visibility and creative expression are highlighted. Share your gifts with confidence and step into the spotlight. This is a year to be seen, to speak your truth, and to let your passion guide your decisions. Your charisma is amplified, making this an excellent time for public presentations, creative launches, and romantic pursuits. Guard against burnout by pacing yourself. Summer will be a particularly powerful time for manifestation.'
      : f.stemElement === 'Earth'
      ? 'stability and consolidation are the themes. Focus on strengthening your foundations, completing ongoing projects, and building sustainable systems in your life. This is a year for harvest — gather the fruits of your previous efforts and store them wisely. Your patience is your greatest asset. Real estate, long-term investments, and relationship commitments made this year have a high probability of success. Late summer and early autumn are especially favorable.'
      : f.stemElement === 'Metal'
      ? 'clarity and decisive action are favored. Cut away what no longer serves you, make difficult decisions with confidence, and structure your life for greater efficiency. This is a year for editing, refining, and perfecting. Your discernment is at its peak — trust your ability to distinguish what is essential from what is merely habitual. Legal matters, major purchases, and structural changes are favored. Autumn brings the clearest energy for important decisions.'
      : 'adaptability and deep wisdom are your allies. Flow with change rather than resisting it, trust your intuition to guide you through uncertainty, and invest in your inner resources. This is a year of depth and reflection — what you learn now will serve you for years to come. Strategic planning, spiritual practice, and deep study are favored. Winter is the most powerful season for inner work and long-term visioning.';

    return `The year of the ${f.animal} (${f.stemEn} ${f.branchEn}) brings ${f.stemElement} energy into your life. ${f.relationship || 'This years energy creates a dynamic interaction with your Day Master, influencing your decisions and experiences.'}. ${interactions} This combination suggests that ${seasonalAdvice}`;
  };
