...
function buildCoverPage(doc, data) {
  ...
  doc.fontSize(11)
    ...
    .text('SOUL ELEMENTS', 55, 160, { letterSpacing: 0.3 });

  doc.fontSize(18)
    .font('Inter-Bold')
    .fillColor(COLORS.textPrimary)
    .text('Destiny Audit', 55, 185);
...
function buildDocumentStructure(doc, tier) {
  ...
  doc.fontSize(11)
    .font('Inter-Bold')
    .fillColor(COLORS.gold)
    .text('DOCUMENT STRUCTURE', 55, 60, { letterSpacing: 0.15 });
...
function buildArchitecturalChart(doc, data) {
  ...
  doc.fontSize(11)
    .font('Inter-Bold')
    .fillColor(COLORS.gold)
    .text('ARCHITECTURAL CHART', 55, 60, { letterSpacing: 0.15 });
...
function buildFourPillarsDetail(doc, data) {
  ...
  doc.fontSize(11)
    .font('Inter-Bold')
    .fillColor(COLORS.gold)
    .text('PILLAR DEEP ANALYSIS', 55, 60, { letterSpacing: 0.15 });
...
function buildElementDistribution(doc, data) {
  ...
  doc.fontSize(11)
    .font('Inter-Bold')
    .fillColor(COLORS.gold)
    .text('ELEMENTAL DISTRIBUTION', 55, 60, { letterSpacing: 0.15 });
...
function buildElementBalance(doc, data) {
  ...
  doc.fontSize(11)
    .font('Inter-Bold')
    .fillColor(COLORS.gold)
    .text('ELEMENT BALANCE & CYCLE ANALYSIS', 55, 60, { letterSpacing: 0.15 });
...
function buildTenDeities(doc, data) {
  ...
  doc.fontSize(11)
    .font('Inter-Bold')
    .fillColor(COLORS.gold)
    .text('TEN DEITIES ANALYSIS', 55, 60, { letterSpacing: 0.15 });
...
function buildLuckCycles(doc, data) {
  ...
  doc.fontSize(11)
    .font('Inter-Bold')
    .fillColor(COLORS.gold)
    .text('LUCK CYCLES OVERVIEW', 55, 60, { letterSpacing: 0.15 });
...
function buildLuckCyclesDetail(doc, data) {
  ...
  doc.fontSize(11)
    .font('Inter-Bold')
    .fillColor(COLORS.gold)
    .text('LUCK CYCLES — DETAILED ANALYSIS', 55, 60, { letterSpacing: 0.15 });
...
function buildAnnualForecast(doc, data) {
  ...
  doc.fontSize(11)
    .font('Inter-Bold')
    .fillColor(COLORS.gold)
    .text('ANNUAL ENERGY FORECAST', 55, 60, { letterSpacing: 0.15 });
...
function buildNaYinShenSha(doc, data) {
  ...
  doc.fontSize(11)
    .font('Inter-Bold')
    .fillColor(COLORS.gold)
    .text('NA YIN & SHEN SHA', 55, 60, { letterSpacing: 0.15 });
...
function buildPersonalityProfile(doc, data) {
  ...
  doc.fontSize(11)
    .font('Inter-Bold')
    .fillColor(COLORS.gold)
    .text('PERSONALITY PROFILE', 55, 60, { letterSpacing: 0.15 });
...
function buildCareerStrategy(doc, data) {
  ...
  doc.fontSize(11)
    .font('Inter-Bold')
    .fillColor(COLORS.gold)
    .text('CAREER & WEALTH STRATEGY', 55, 60, { letterSpacing: 0.15 });
...
function buildRemediationGuide(doc, data) {
  ...
  doc.fontSize(11)
    .font('Inter-Bold')
    .fillColor(COLORS.gold)
    .text('REMEDIATION GUIDE', 55, 60, { letterSpacing: 0.15 });
...
function buildPersonalAffirmation(doc, data) {
  ...
  doc.fontSize(11)
    .font('Inter-Bold')
    .fillColor(COLORS.gold)
    .text('YOUR AFFIRMATION', centerX, 160, { align: 'center', letterSpacing: 0.15 });
...
function drawCycleDiagram(doc, startX, startY, elements, data) {
  ...
  elements.forEach((elem, i) => {
    ...
    doc.fontSize(5)
      .font('Inter')
      .fillColor(COLORS.textPrimary)
      .text(`${pct}%`, x - 8, y - 5, { width: 16, align: 'center' });
  });
