        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            {touched.birthDate && !isValidDate && (
              <p className="text-xs mt-1" style={{ color: 'rgba(255,80,80,0.8)' }}>Please enter your date of birth</p>
            )}
          </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              ...
              <label className="flex items-center gap-2 text-xs" style={{ color: '#6B6F80', cursor: 'pointer' }}>
            ...
            {!form.unknownTime ? (
              ...
              <div className="warning-box p-3 rounded-lg text-xs" style={{ color: '#8B8FA3' }}>
          ...
          <div>
            ...
            <p className="text-xs mt-1" style={{ color: '#6B6F80' }}>Used to calculate your True Solar Time.</p>
          </div>

          {/* Lat / Lng */}
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-xs mb-1" style={{ color: '#6B6F80' }}>Latitude</label>
            ...
            <div>
              <label className="block text-xs mb-1" style={{ color: '#6B6F80' }}>Longitude</label>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-xs mb-1" style={{ color: '#6B6F80' }}>Timezone Offset (e.g. 8)</label>
            ...
            <div>
              <label className="block text-xs mb-1" style={{ color: '#6B6F80' }}>Timezone Name</label>
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                <button key={opt.value} type="button" onClick={() => handleChange('goal', opt.value)}
                  ...
                  style={{ background: form.goal === opt.value ? 'rgba(201, 168, 76, 0.1)' : 'rgba(255,255,255,0.02)', border: form.goal === opt.value ? '1px solid rgba(201, 168, 76, 0.4)' : '1px solid rgba(255,255,255,0.06)' }}>
                  {opt.label}
                </button>
              ))}
            </div>
          ...
          {/* Error */}
          {error && (
            <div className="p-3 rounded-lg text-sm" style={{ background: 'rgba(255, 50, 50, 0.08)', border: '1px solid rgba(255, 50, 50, 0.2)', color: 'rgba(255,80,80,0.9)' }}>
              {error}
            </div>
          )}
